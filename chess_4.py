            ...
            try:
                ...
                if again == 'Y':
                    ...
                    if self.board[destination_x_bp_7][destination_y_bp_7] == '.' :
                        ...
                        elif (self.position_x_bp_7,self.position_y_bp_7) == (1,7):
...
class Engine(Chess_Board):
    ...
    def play(self):
        ...
        print('PLEASE WRITE WHAT FIGURE YOU CHOOSE TO MOVE:','\n'
              '-->white_king, white_queen, white_rook_L, white_bishop_L','\n'
              '-->white_knight_L, white_rook_R, white_knight_R, white_bishop_R','\n'
              '-->white_pawn_0,white_pawn_1,white_pawn_2,white_pawn_3','\n'
              '-->white_pawn_4,black_pawn_5,black_pawn_6,black_pawn_7','\n'
              '-->black_king,black_rook_L,black_knight_L,black_bishop_L','\n'
              '-->black_bishop_L,black_queen,black_rook_R,black_knight_R,','\n'
              '-->black_bishop_R,black_pawn_0,black_pawn_1,black_pawn_2','\n'
